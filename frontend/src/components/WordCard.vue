...
<template>
  <div
    class="rounded-lg shadow-md transition-all duration-300 hover:shadow-lg cursor-pointer"
  ...
  >
    <div class="p-6 relative">
      ...
      <div class="absolute top-4 right-4 flex space-x-2">
        ...
        >
          <BookmarkIcon :class="['w-5 h-5', isFavorite ? 'fill-current' : 'stroke-current']" />
        </button>
        <button

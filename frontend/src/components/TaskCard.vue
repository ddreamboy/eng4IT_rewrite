<template>
    <div class="relative">
        <!-- Карточка задания -->
        <div class="rounded-lg shadow-md transition-all duration-300" :class="[
            themeStore.isDark ? 'bg-dark-secondary' : 'bg-light-secondary',
            expanded ? 'z-20 shadow-xl' : 'hover:shadow-lg'
        ]">
            <!-- Кнопка информации -->
            ...
            <div class="p-6 cursor-pointer" @click="navigateToTask">
                ...
                <div class="overflow-hidden transition-all duration-300"
                    :class="expanded ? 'mt-6 max-h-[1000px] opacity-100' : 'max-h-0 opacity-0'">

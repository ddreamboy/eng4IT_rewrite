...
<template>
  <div class="relative h-full">
    <div
      class="h-full rounded-lg shadow-md transition-all duration-300 hover:shadow-lg"
          ...
          >
            ...
            <div class="mb-4">
              ...
              <div class="flex gap-2">
                <span
                  v-for="level in task.difficulty_levels"
                  :key="level"
                  class="px-2 py-1 text-xs rounded-full"
                  :class="[
                    themeStore.isDark
...
import { MessageSquare, Link2, Book, Languages, Mail, Info } from 'lucide-vue-next'

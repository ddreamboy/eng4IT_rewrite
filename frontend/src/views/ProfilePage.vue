    ...
    <div class="space-y-6">
      ...
      <div class="p-6 rounded-lg bg-light-secondary dark:bg-dark-secondary">
        <div class="flex items-center space-x-4 mb-6">
          <div class="w-16 h-16 rounded-full bg-light-accent dark:bg-dark-accent flex items-center justify-center">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="p-6 rounded-lg bg-light-secondary dark:bg-dark-secondary">
          ...
          <div class="space-y-4">
            <div v-for="(progress, category) in profile?.statistics?.category_progress" 
                 :key="category" 
                 class="space-y-2">
              ...
              <div class="h-2 rounded-full bg-light-primary/10 dark:bg-dark-primary/10">
                <div class="h-full rounded-full bg-light-accent dark:bg-dark-accent transition-all"
        ...
        <div class="p-6 rounded-lg bg-light-secondary dark:bg-dark-secondary md:col-span-2">
          ...
          <div class="flex flex-wrap gap-2">
            <span v-for="word in profile?.statistics?.favorite_words" 
                  :key="word"

...
<template>
    <div class="container mx-auto px-4 py-8">
        ...
        <div v-if="loading" class="flex justify-center items-center py-12">
            <div class="animate-spin rounded-full h-8 w-8 border-b-2" :class="[
                themeStore.isDark ? 'border-dark-accent' : 'border-light-accent'
            ]"></div>
        </div>
            ...
            <div class="rounded-lg p-6" :class="[
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <StatDetailItem title="Выполненные задания" :value="profile.statistics?.completed_tasks || 0" />
                        <StatDetailItem title="Точность"
                ...
                <div class="mt-6">
                    ...
                    <div v-if="profile.statistics?.favorite_words?.length" class="flex flex-wrap gap-2">
                        <span v-for="word in profile.statistics.favorite_words" :key="word"
                            class="px-2 py-1 rounded-full text-sm" :class="[
                                themeStore.isDark
